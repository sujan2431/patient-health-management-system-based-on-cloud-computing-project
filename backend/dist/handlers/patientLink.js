...
export async function handler(event) {
    ...
    if (event.httpMethod !== "POST" || event.path !== "/patients/link-user")
        return notFound();
    ...
    await getPool().execute("UPDATE Patients SET patient_user_id = :patient_user_id WHERE patient_id = :patient_id", { patient_user_id: parsed.data.patient_user_id, patient_id: parsed.data.patient_id });
